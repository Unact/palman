...
part 'api_goods_list_goods.dart';
part 'api_goods_list.dart';
part 'api_goods_partners_pricelist.dart';
part 'api_goods_payback.dart';
part 'api_goods_restriction.dart';
part 'api_goods_return_stock.dart';
...
part 'api_partners_return_act_type.dart';
part 'api_payback.dart';
part 'api_paybacks_data.dart';
part 'api_point_format.dart';
part 'api_point_image.dart';
part 'api_point.dart';
part 'api_points_data.dart';
part 'api_pre_encashment.dart';
...
part 'api_return_act_line.dart';
part 'api_return_act_type.dart';
